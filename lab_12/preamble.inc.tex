...
\usepackage{array}                 % для >{\centering\arraybackslash}p{...}
\usepackage[normalem]{ulem}        % даёт \uline, не ломая \emph

% Универсальное табличное окружение с настраиваемым \arraystretch:
